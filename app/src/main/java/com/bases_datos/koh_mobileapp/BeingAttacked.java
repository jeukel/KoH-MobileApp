...
public class BeingAttacked extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CountDownTimer(down, 1000) {

            public void onTick(long millisUntilFinished) {
                time1.setText("seconds remaining: " + millisUntilFinished / 1000);
                if( (down/1000) == ( 105 | 90 | 75 | 60 | 45 | 30 | 15 | 0 )){
                    ...
                    if (conn.requestWebService(3, query) != null) {
                        startActivity(new Intent(BeingAttacked.this, Fight.class));
                    }
                }
